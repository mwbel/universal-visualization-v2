...
**选择理由**:
1. **用户基数大**: 高等数学是大学理工科必修课程，覆盖千万级学生群体
2. **可视化需求强**: 极限、导数、积分等概念高度抽象，可视化能显著提升理解
3. **知识体系成熟**: 13章标准化知识结构，便于系统化建设知识库
4. **技术可行性高**: 2D可视化可满足大部分知识点展示需求（函数图像、几何动画）
...
| 章节 | 核心知识点 | 可视化需求 |
|-----|-----------|-----------|
| 第1章 基本知识 | 集合、函数、初等函数 | 函数图像绘制、性质对比 |
| 第2章 极限与连续 | 数列极限、函数极限、连续性 | 极限过程动画、ε-δ定义可视化 |
| 第3章 导数与微分 | 导数定义、求导法则、微分 | 切线动画、导数几何意义 |
| 第4章 微分中值定理 | 罗尔定理、拉格朗日定理、柯西定理 | 定理几何解释动画 |
| 第5章 积分 | 不定积分、定积分、积分方法 | 黎曼和动画、面积计算过程 |
| 第6章 定积分的应用 | 面积、体积、弧长、物理应用 | 旋转体生成动画、元素法演示 |
| 第7章 空间解析几何 | 向量、平面、直线、曲面 | 3D几何图形交互 |
| 第8章 多元函数微分学 | 偏导数、全微分、极值 | 偏导数几何意义、梯度可视化 |
| 第9章 重积分 | 二重积分、三重积分 | 积分区域划分动画 |
| 第10章 曲线曲面积分 | 曲线积分、曲面积分、格林公式 | 向量场可视化 |
| 第11章 无穷级数 | 数项级数、幂级数、傅里叶级数 | 级数收敛动画、部分和逼近 |
| 第12章 微分方程 | 一阶方程、高阶方程、线性方程组 | 解曲线族、方向场 |
| 第13章 差分方程 | 差分概念、线性差分方程 | 离散过程可视化 |
...
- **可视化**:
  ...
  - KaTeX (数学公式渲染)
  - **MathJax** (复杂数学公式渲染)
  - **Function Plot** (函数图像绘制)
- **动画**: Framer Motion / GSAP
- **代码沙箱**: iframe + postMessage
- **状态管理**: Zustand / Redux Toolkit
- **数学输入**: MathLive (数学公式编辑器)
...
```
- node_id: string
- subject: string          // 学科: "高等数学"
- chapter: number          // 章节号: 1-13
- topic: string           // 知识点名称
- description: string     // 详细描述
- prerequisites: Array<string>  // 前置知识点ID列表
- related_nodes: Array<string>  // 关联知识点ID列表
- difficulty: number      // 难度等级: 1-5
- visualization_templates: Array<string>  // 可视化模板ID
- exercise_count: number  // 配套习题数量
- formula_list: Array<string>  // 相关公式列表
```

**高等数学知识节点示例**:
```json
{
  "node_id": "calculus-02-001",
  "subject": "高等数学",
  "chapter": 2,
  "topic": "数列极限",
  "description": "当n趋近于无穷大时，数列{a_n}的极限定义...",
  "prerequisites": ["calculus-01-003"],
  "related_nodes": ["calculus-02-002", "calculus-02-005"],
  "difficulty": 3,
  "visualization_templates": ["sequence-limit-animation"],
  "exercise_count": 15,
  "formula_list": ["\\lim_{n\\to\\infty} a_n = L"]
}
```
...
### Phase 1: MVP开发 - 高等数学学科基础
- **Week 1-2**: 基础架构搭建 + NLU模块
  - 搭建项目基础框架
  - 实现数学公式解析器（LaTeX支持）
  - 完成问题意图识别模块
  
- **Week 3-4**: 知识库建设 + RAG检索系统
  - 导入高等数学13章知识内容
  - 构建向量数据库索引
  - 实现Graph RAG检索
...
| v1.1 | 2026-03-15 | - | 新增高等数学学科规划：明确MVP学科范围为高等数学，添加13章知识点覆盖表，更新知识节点数据模型，细化开发里程碑（分阶段实施高等数学学科） |
